...
executable_name="HHO_Helmholtz/hho_helmholtz"
...
#	 Execute code
  	$executable --mesh $meshfile --edgedegree $k --celldegree $l --orthonormalise $ortho --use_threads $use_threads --plot $plotfile --wave_number $wave_number
#	 Move outputs
