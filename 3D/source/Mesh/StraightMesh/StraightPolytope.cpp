...
namespace PolyMesh3D
{
    namespace StraightMesh
    {
        ...
        size_t Polytope::n_faces() const { return _faces.size(); }
        ...
        void Polytope::add_face(Face *face)
        {
        ...
        void Polytope::remove_face(Face *face)
        {
        ...
        Face *Polytope::face(const size_t i) const
        {
        ...
        int Polytope::index_face(const Face *face) const
        {
