...
namespace PolyMesh2D
{
    namespace Functional
    {
        ...
        **/
         ...
         * there exists a most one local maximum and one local minimum (given an infintite domain extension of the curve)
